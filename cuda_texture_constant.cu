...
__global__ void convolution_kernel(short* out_image,int width,int height)
{
    ...
    out_image[pos] = dev_H[0]*tex1Dfetch(tex_in_image,  up_left) + dev_H[1]*tex1Dfetch(tex_in_image,up     ) + dev_H[2]*tex1Dfetch(tex_in_image,up_right  )
                    +dev_H[3]*tex1Dfetch(tex_in_image,     left) + dev_H[4]*tex1Dfetch(tex_in_image,pos    ) + dev_H[5]*tex1Dfetch(tex_in_image,right     )
                    +dev_H[6]*tex1Dfetch(tex_in_image,down_left) + dev_H[7]*tex1Dfetch(tex_in_image,down   ) + dev_H[8]*tex1Dfetch(tex_in_image,down_right);
...
int main()
{
    ...
    imwrite("cuda_texture_constant.jpg",abs_dst);
